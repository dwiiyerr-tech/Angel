...
export const LIVE_SETTING_KEYS = new Set([
  ...
  'catastrophic_liquidity_retention', 'catastrophic_loss_percent',
  ...
  'edge_admission_live_enabled',
  'edge_min_quality_score', 'edge_min_survival_probability',
  'edge_min_runner_probability', 'edge_min_expected_r',
  'tp1_r_multiple',
  'risk_per_trade_sol',
  ...
  'runner_lifecycle_live_enabled', 'probe_scale_live_enabled',
  'probe_entry_fraction', 'runner_weakening_buyer_ratio',
